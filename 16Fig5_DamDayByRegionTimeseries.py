...
fig, axs = plt.subplots(4, 2, sharex=True, sharey=True, figsize=(12, 9))
...
plt.savefig(work_dir + 'plot/5DamDayByRegionTimeSeries_CherryYieldCountyInState.png', bbox_inches='tight')
plt.close()