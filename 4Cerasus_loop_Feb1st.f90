...
570         GDD=0.0
!
!  BEGIN SEASONAL GDD ACCUMS 1 FEB
!
572        	IF(CD.LE.32) GOTO 574
			cdhtot=cdhtot+gdd
...
!    OPEN(13,FILE='output_yearly_list_test.txt',STATUS='OLD')
    do i=1,100000000
        ...
        read(12, *)outputfile1
        output1 = "/home/mmfire/Diane/Ag_paper/GDD/GDD_output/Feb1st/daily/"//outputfile1
!        output1 = "zz_"//outputfile1
        read(13, *)outputfile2
        output2 = "/home/mmfire/Diane/Ag_paper/GDD/GDD_output/Feb1st/yearly/"//outputfile2
