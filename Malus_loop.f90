SUBROUTINE MALUSv001(input, output1, output2)
...
PROGRAM MAIN
    ...
    do i=1,1000000000
        read(11, *)inputfile
        input = "./input/GDD_data/"//inputfile
        read(12, *)outputfile1
        output1 = "./output/daily/"//outputfile1
        read(13, *)outputfile2
        output2 = "./output/yearly/"//outputfile2
        call MALUSv001(input, output1, output2)
    end do
