...
!rmax,rmin,rsr
    INTEGER YR,MO,DAY,CD,nyr,GDD20flag
!    REAL imax,imin
!sr, iflag,precip
...
570         GDD=0.0
!
!  BEGIN SEASONAL GDD ACCUMS from GT 20, GDD ACCUMULATION LOGIC
!
572         IF (reset_flag) THEN
                cdhtot = cdhtot + gdd
                IF (cdhtot > 20.0) THEN
                    reset_flag = .FALSE.
                    cdhtot = 0.0
...
200     continue
        ...
        SFLAG=0
        bflag=0
        write(3,11) yr,sidegreen(j),bloom(j),pdays,yld,GDD20flag

11      format(i6,2i10,i6,f8.2,i10)
        PDAYS=0
100 continue
    stop
...
PROGRAM MAIN
    ...
    OPEN(11,FILE='/home/mmfire/Diane/Ag_paper/GDD/input_list.txt',STATUS='OLD')
    OPEN(12,FILE='/home/mmfire/Diane/Ag_paper/GDD/output_daily_list.txt',STATUS='OLD')
    OPEN(13,FILE='/home/mmfire/Diane/Ag_paper/GDD/output_yearly_list.txt',STATUS='OLD')
...
!    OPEN(13,FILE='output_yearly_list_test.txt',STATUS='OLD')
    do i=1,100000000
        ...
        read(12, *)outputfile1
        output1 = "/home/mmfire/Diane/Ag_paper/GDD/GDD_output/GDD20_wthflag/daily/"//outputfile1
!        output1 = "zz_"//outputfile1
        read(13, *)outputfile2
        output2 = "/home/mmfire/Diane/Ag_paper/GDD/GDD_output/GDD20_wthflag/yearly/"//outputfile2
